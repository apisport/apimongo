                ...
                <div className="col col-md-4 col-12 card shadow">
                    <div className="card text-start">
                        ...
                        <div className="card-body">
                            ...
                            <span className="card-text text-muted" style={{ color: "black" }}><strong>Harga mulai dari </strong><br></br><span style={{ color: "green" }}>{props.lapanganVenue.length === 0 ? ('Tidak ada data lapangan') : (`Rp ${props.lapanganVenue[0].hargaPagi}.000`)}</span></span>
                        </div>
                    </div>
                </div>
            </Link>
